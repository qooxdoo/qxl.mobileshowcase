  ...
  qx.Bootstrap.define("qx.bom.client.Engine", {
    ...
    statics: {
      ...
      getVersion: function getVersion() {
        ...
        if (qx.bom.client.Engine.__P_36_0()) {
        ...
        } else if (qx.bom.client.Engine.__P_36_1()) {
        ...
        } else if (qx.bom.client.Engine.__P_36_2()) {
        ...
        } else if (qx.bom.client.Engine.__P_36_3()) {
      ...
      __P_36_0: function __P_36_0() {
        ...
        if (qx.bom.client.Engine.__P_36_4()) {
          return true;
        }
...
//# sourceMappingURL=Engine.js.map?dt=1592642583661