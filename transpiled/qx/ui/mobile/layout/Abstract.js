    ...
    members: {
      ...
      connectToWidget: function connectToWidget(widget) {
        ...
        if (widget) {
          ...
          if (this.__P_144_0) {
            for (var property in this.__P_144_0) {
              this.reset(property);
              this.set(property, this.__P_144_0[property]);
            }
          }
        } else {
          this.__P_144_0 = null;
      ...
      _getChildLayoutPropertyValue: function _getChildLayoutPropertyValue(widget, property) {
        var cache = this.__P_144_2(widget);
...
//# sourceMappingURL=Abstract.js.map?dt=1592642593730