  ...
  qx.Class.define("qx.event.handler.Application", {
    ...
    */
    ...
    construct: function construct(manager) {
      ...
      this.__P_84_2 = false;
      this.__P_84_3 = false;
      this.__P_84_4 = false; // Initialize observers
    ...
    members: {
      ...
      */
      ...
      __P_84_5: function __P_84_5() {
        ...
        if (!this.__P_84_2 && this.__P_84_0 && qx.$$loader.scriptLoaded) {
          ...
          if (qx.core.Environment.get("engine.name") == "mshtml") {
            if (qx.event.Registration.hasListener(this._window, "ready")) {
              this.__P_84_2 = true; // Fire user event
       ...
       *
       */
      __P_84_6: function __P_84_6() {
        this.__P_84_3 = true; // Fire user event
      ...
      */
      ...
      _onNativeLoad: function _onNativeLoad() {
        var callback = qx.core.Environment.select("qx.globalErrorHandling", {
          "true": qx.event.GlobalError.observeMethod(this.__P_84_7),
          "false": this.__P_84_7
        });
      ...
      _onNativeUnload: function _onNativeUnload() {
        var callback = qx.core.Environment.select("qx.globalErrorHandling", {
          "true": qx.event.GlobalError.observeMethod(this.__P_84_8),
          "false": this.__P_84_8
        });
        callback.apply(this, arguments);
      },
...
//# sourceMappingURL=Application.js.map?dt=1592642589063