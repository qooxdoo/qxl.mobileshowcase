  ...
  members: {
    ...
    _initialize() {
      ...
      var canvasSize = Math.max(
        qx.bom.Viewport.getWidth() * 1.5,
        qx.bom.Viewport.getHeight() * 1.5
      );
      ...
      qx.bom.element.Style.set(
        canvas.getContentElement(),
        "width",
        this.__canvasSize + "px"
      );
      qx.bom.element.Style.set(
        canvas.getContentElement(),
        "height",
     ...
     */
    __clearCanvas() {
      this.__canvas.getContentElement().width =
        this.__canvas.getContentElement().width;
      var ctx = this.__canvas.getContext2d();
      ctx.clearRect(
        0,
        0,
        this._to(this.__canvasSize),
        this._to(this.__canvasSize)
      );
     ...
     */
    _onTrackStart(evt) {
      this.__canvasLeft = qx.bom.element.Location.getLeft(
        this.__canvas.getContentElement(),
        "padding"
      );
      this.__canvasTop = qx.bom.element.Location.getTop(
        this.__canvas.getContentElement(),
        "padding"
      );
