...
qx.Class.define("qxl.mobileshowcase.page.List", {
  ...
  members: {
    ...
    _initialize() {
      ...
      this._loadingIndicator = new qx.ui.mobile.dialog.BusyIndicator(
        "Loading more items ..."
      );
      ...
      var list = new qx.ui.mobile.list.List({
        ...
        configureGroupItem(item, data, group) {
    ...
    _onWaypoint(evt) {
      ...
      qx.bom.element.Attribute.set(
        targetElement,
        "data-waypoint-label",
        this._waypointsY[index] + " [" + direction + "]"
      );
